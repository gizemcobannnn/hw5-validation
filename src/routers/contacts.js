...
router.patch('/contacts/:contactId',checkRoles(ROLES.ADMIN,ROLES.PARENT),upload.single('photo'), validateBody(contactSchema), isValidId, ctrlWrapper(patchContactController));
